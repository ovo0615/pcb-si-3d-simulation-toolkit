...
![依指定訊號與擴張距離產生裁切範圍](./graph/指定裁切區_20260730.png)
...
![裁切完成後的通道 Layout 與 Port](./graph/裁切後結果_20260730.png)
...
![清理前後的 Layout 差異對比](./graph/裁切後比對_20260730.png)
...
![排程模擬過程與各分段狀態](./graph/SIwave排程模擬過程_20260730.png)
