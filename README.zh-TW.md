...
| 其他 | — | 切面安全視覺化、排程求解、外部 Touchstone 串接、整片求解對照、遠端求解包、一鍵 HTML 報告 |
...
![逐段 HFSS／SIwave 建議與判斷原因](./graph/混合求解設定_20260805.png)

![混合求解排程執行中](./graph/混合排程模擬過程_20260805-public.png)

![串接後 S 參數：單端／差動可切換](./graph/S參數展現_20260810.png)

![QuickEye 眼圖與眼高、眼寬量測](./graph/QuickEye眼圖_20260809-public.png)

![TDR 阻抗定位：劇變位置標回 Layout 走線](./graph/TDR_20260810.png)

![一鍵產出的 HTML 報告](./graph/一鍵產出HTML報告_1_20260810.png)
