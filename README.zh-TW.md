...
**那個條件不是小字，是主詞。** 真實板上切在 3 mm 內完全沒有縫合 Via 的位置時，分段串接到 1 GHz 仍然只差 0.040 dB，但**可用頻率上限只剩 1.35 GHz**，3 GHz 以上就長到 1.5 dB 以上。[真實板全頻對照](./validation/segmentation/真實板全頻對照_20260817.md)
